...
GitHub: github.com/SmagArt/chat-merge (v2.1.1 — bugfix release)

---

## Текущее состояние (март 2026, v2.1.1)
...
- GUI v2.1.1: выбор папки, drag & drop, история 5 папок, фильтр по датам
...
v2.1.1 — текущий публичный релиз (Windows).
