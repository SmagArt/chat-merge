...
1. Скачай `MergeChat_v2.0.dmg` из [Releases](https://github.com/SmagArt/chat-merge/releases)
...
```
Скрипт соберёт `.app` и создаст `dist_mac/MergeChat_v2.0.dmg` автоматически.
