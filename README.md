...
- Метки времени сообщений — включить/выключить одной кнопкой
- Разбивка результата по месяцам или годам (удобно для больших чатов)
...
```
Скрипт соберёт `.app` и создаст `dist_mac/MergeChat_v2.2.dmg` автоматически.
...
5. При желании задай фильтр по датам, метки времени, разбивку на файлы
6. Нажми «Запустить»
