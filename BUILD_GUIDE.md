# BUILD_GUIDE.md — Merge Chat v2.1.1
...
Готовый файл появится в папке `dist_installer\MergeChat_Setup_v2.1.1.exe`.
...
3. Упаковывает в `dist_mac/MergeChat_v2.1.1.dmg`
...
**Название:** `v2.1.1 — Merge Chat`

**Описание:**
```
## Merge Chat v2.1.1 — первый публичный релиз
...
### Установка Windows
Скачай MergeChat_Setup_v2.1.1.exe — Python и все зависимости установятся автоматически.
При наличии NVIDIA видеокарты torch с CUDA установится автоматически.

### Установка macOS
Скачай MergeChat_v2.1.1.dmg, открой, перетащи MergeChat в Программы.
При первом запуске: правый клик → Открыть.
```

**Файлы релиза:**
- `MergeChat_Setup_v2.1.1.exe` — Windows установщик
- `MergeChat_v2.1.1.dmg` — macOS DMG
...
cd папка-проекта
git add .
git commit -m "v2.1.1 — initial public release"
git push origin main
```

Затем на GitHub: Releases → Draft new release → Tag: v2.1.1 → загрузить файлы.
